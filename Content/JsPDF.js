...
{
 "use strict";
 var Global,WebSharper,JsPDF,Sample,Client,Operators,Obj,UI,Templating,Runtime,Server,TemplateInstance,Arrays,ProviderBuilder,Handler,JsPDF_Templates,HtmlModule,attr,Collections,List,Unchecked,System,Guid,Dictionary,HashSet,Client$1,Seq,Var$1,Client$2,Templates,Doc,JavaScript,Pervasives,AttrProxy,Object,DictionaryUtil,Enumerator,T,Var,ConcreteVar,Snap,View,CheckedInput,Numeric,EventTarget,Node,JS,DomUtility,Attrs,Abbrev,Fresh,SC$1,WindowOrWorkerGlobalScope,SC$2,Docs,DocElemNode,CharacterData,Elt,Prepare,Slice,KeyCollection,An,Settings,Mailbox,Array,HashSetUtil,Attrs$1,Dyn,SC$3,AttrModule,List$1,T$1,Strings,Updates,Docs$1,RunState,NodeSet,Anims,SC$4,String,SC$5,Concurrency,AppendList,SC$6,Char,DynamicAttrNode,Easing,AsyncBody,SC$7,CT,HashSet$1,Scheduler,CancellationTokenSource,DomNodes,Error,OperationCanceledException,Lazy,SC$8,Queue,LazyExtensionsProxy,LazyRecord,IntelliFactory,Runtime$1,Math,console,$,Date;
 Global=self;
 ...
 JsPDF_Templates=Global.JsPDF_Templates=Global.JsPDF_Templates||{};
 ...
 {
  var doc,pdf,pdfRender,a,b,p,i;
  doc=new Global.jsPDF();
  doc.text("Hello world!",10,10,function()
  {
   return new Obj.New();
  });
  doc.addPage();
  doc.text("Hello world on Page 2!",10,10,function()
  {
   return new Obj.New();
  });
  ...
  pdfRender=Doc.Element("object",[AttrProxy.Create("width","100%"),AttrProxy.Create("height","100%"),AttrProxy.Create("data",pdf),AttrProxy.Create("type","application/pdf")],[]);
  a=(b=ProviderBuilder.Make().WithHole({
   $:0,
   $0:"pdf",
   $1:pdfRender
  }),(p=Handler.CompleteHoles(b.k,b.h,[]),(i=new TemplateInstance.New(p[1],JsPDF_Templates.main(p[0])),(b.i=i,i)))).get_Doc();
 ...
 JsPDF_Templates.main=function(h)
 {
